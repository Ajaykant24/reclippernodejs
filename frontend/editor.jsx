...
export default function Editor() {
  ...
  // Small 4px right margin allows text to get closer to frame edge while maintaining breathing room.
  const textBlockW = clamp(frameW * textWidthRatio, 90, Math.max(90, frameW - 4))
